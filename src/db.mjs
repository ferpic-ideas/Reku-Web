...
export const initDb = async () => {
  ...
  await query(`
    ...
    CREATE TABLE IF NOT EXISTS appointments (
      ...
      triage_reminder_last_attempted_at TIMESTAMPTZ,
      triage_reminder_sent_at TIMESTAMPTZ,
      triage_reminder_message_id TEXT,
      triage_reminder_error TEXT,
      triage_reminder_count INTEGER NOT NULL DEFAULT 0,
